package com.yunde.website.service.impl;

import com.yunde.frame.tools.JsonKit;
...
public class RedisService<T> implements IRedisService {
    ...
    public <T> boolean setList(String key, List<T> list) throws Exception {
        ...
        String value = JsonKit.getJsonString(list);
    ...
    public <T> List<T> getList(String key,Class<T> clz)  throws Exception{
        ...
        String json = get(key);
        if(json!=null){
            List<T> list = JsonKit.readJson2Array(json,clz);
            return list;
        }
        return null;
    }
    ...
    public long lpush(final String key, Object obj)throws Exception {
        Assert.hasText(key,"Key is not empty.");
        final String value = JsonKit.getJsonString(obj);
    ...
    public void hmset(String key, Object obj)  throws Exception{
        Assert.hasText(key,"Key is not empty.");
        Map<byte[], byte[]> data=JsonKit.readJsonByteMap(JsonKit.getJsonString(obj));
    ...
    public <T> T hget(String key, Class<T> clz)  throws Exception{
        ...
        return redisTemplate.execute(new RedisCallback<T>() {
            ...
            public T doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                return JsonKit.json2Obj(JsonKit.getJsonString(result),clz);
            }
        });
    }
    ...
    public<T> List<T>  hmGetAll(String key,Class<T> clz) throws Exception{
        ...
        return redisTemplate.execute(new RedisCallback<List<T>>() {
            ...
            public List<T> doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                return JsonKit.readJson2Array(JsonKit.getJsonString(dataList),clz);
            }
        });
    }
